...
# session answers a question through scry's MCP server.
#
...
AGENT_HOME="/private/tmp/scry-demo"
...
cat >"$AGENT_HOME/.claude/settings.json" <<'EOF'
{
  ...
  "permissions": {
    "allow": ["mcp__scry__scry_query", "mcp__scry__scry_search", "mcp__scry__scry_issue", "mcp__scry__scry_status"],
