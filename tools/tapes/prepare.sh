#!/usr/bin/env bash
# Prepare a disposable GADAK_HOME + gadak binary for VHS tapes.
...
echo "[tapes] building gadak binary → $BIN"
CGO_ENABLED=0 go build -trimpath -o "$BIN" "$ROOT/cmd/gadak"

echo "[tapes] seeding GADAK_HOME from examples/demo.db"
...
echo "[tapes] ready (GADAK_HOME=$HOME_DIR)"
echo "[tapes] source $ENV_SH before gadak commands"
