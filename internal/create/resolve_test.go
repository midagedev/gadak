...
// TestMetaForBuiltInDoesNotAssumeCredential is GDK-390: a missing
// createmeta project on built-in is "not in this workspace", not a
// credential failure. Connected keeps the existing sentence.
//
// FAIL-first: MetaFor always names a credential.
func TestMetaForBuiltInDoesNotAssumeCredential(t *testing.T) {
