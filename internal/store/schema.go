...
// beside the file's own stamp so a dev-build refusal names both sides
// without a second command (GDK-1967); issuetap.PersistSchemaVersion is the
// persist side's twin.
func MirrorSchemaVersion() int { return len(migrations) }
