...
쓰지도 않는 Jira를 탓하며 거절했습니다 ([GDK-1793]). 이 태그 전의 감사가 도구가 사실과 다르게
...
토큰을 넘기기 전에 읽어야 할 사실이 됐습니다 ([GDK-1601], [GDK-1622]). 그리고
...
아랫줄을 먹지 않습니다 ([GDK-54]). 목록은 주어진 모든 너비에서 읽힙니다.
...
로컬 사본을 처음부터 끝까지 캐시라고 부릅니다 ([GDK-1323]). 개인 기록은 보고
