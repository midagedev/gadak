...
export const ko = {
  ...
  'column.dev_test_result': '개발 테스트 결과',
  ...
  'filter.jqlCopied': 'JQL을 복사했습니다',
  'filter.jqlCopiedPartial': 'JQL 복사 (Jira에 없는 항목: {omitted})',
  'filter.jqlEmpty': 'JQL로 내보낼 필터가 없습니다',
  'filter.jqlApplied': 'JQL 필터를 적용했습니다',
  'filter.jqlPartial': '적용했습니다. 빠진 절: {clauses}',
  'filter.jqlParseFailed': 'JQL을 해석하지 못했습니다',
  'filter.jqlNotAvailable': 'JQL은 앱 또는 gadak serve가 필요합니다',
  'filter.remove': '필터 제거',
  ...
  'filter.chipResolvedRange': '해결 {from}~{to}',
  'filter.dateFrom': '시작',
  'filter.dateTo': '끝',
  ...
  'bulk.pickLabel': '라벨 선택',
  'bulk.searchLabel': '라벨 입력',
  'bulk.onSelection': '선택에 있음',
  'bulk.typeALabel': '추가할 라벨을 입력하세요',
  ...
  'sidebar.jiraFilters': 'Jira 필터',
  'sidebar.openFilterInJira': '이 필터를 Jira에서 열기',
  ...
  'sidebar.viewDeleteFail': '뷰를 삭제하지 못했습니다. 다시 시도하세요.',
  'sidebar.syncOk': '정상',
  ...
  'sidebar.syncLastChecked': '마지막 확인 {when}',
  'sidebar.serverUnreachable': '서버에 연결하지 못했습니다. 다시 시도하세요.',
  ...
  'sidebar.sectionReorderHint': '드래그 또는 Alt+↑↓로 순서 변경',
  ...
  'view.resolvedWeek.hint': '월요일 이후 해결',
  'view.unnamed': '이름 없는 뷰',

  /* ── Personal ── */
  'personal.favorites': '즐겨찾기',
  'personal.recent': '최근 본 항목',
  ...
  'personal.watchOn': '워치 중 — 상태 변경/코멘트/재오픈 알림',
  ...
  'notif.quietHint': '로컬 시간 · 자정 걸침 가능',
  ...
  'write.createFailed': '이슈 생성에 실패했습니다. 다시 시도하세요.',
  ...
  'write.jiraUnavailable': 'Jira에 연결하지 못했습니다. 연결을 확인한 뒤 다시 시도하세요.',
  'write.workspaceBusy':
  ...
  'write.transitionFailed': '상태 전환에 실패했습니다. 다시 시도하세요.',
  'write.assignFailed': '담당자 변경에 실패했습니다. 다시 시도하세요.',
  'write.priorityFailed': '우선순위 변경에 실패했습니다.',
  'write.prioritiesFailed': '우선순위를 불러오지 못했습니다.',
  'write.changePriority': '우선순위 변경',
  'write.loadingPriorities': '불러오는 중…',
  'write.noPriorities': '이 사이트에 우선순위가 없습니다.',
  'write.summaryFailed': '제목 변경에 실패했습니다.',
  'write.editTitle': '제목 수정',
  'write.editDescription': '설명 수정',
  'write.descriptionFailed': '설명 변경에 실패했습니다.',
  'write.descriptionFormatWarn': '저장하면 서식·임베드가 제거됩니다.',
  'write.saveAsPlain': '평문으로 저장',
  'write.titleRequired': '제목은 비울 수 없습니다.',
  'write.labelsFailed': '라벨 변경에 실패했습니다.',
  'write.addLabel': '라벨 추가',
  'write.addLabelNamed': '‘{label}’ 추가',
  'write.removeLabel': '{label} 제거',
  'write.editMetaFailed': '편집 항목을 불러오지 못했습니다.',
  'write.fieldFailed': '필드 변경에 실패했습니다.',
  'write.commentFailed': '코멘트 등록에 실패했습니다. 다시 시도하세요.',
  'write.commentPosted': '{key}에 코멘트를 등록했습니다.',
  ...
  'jiraSettings.deleteConfirm': '한 번 더 누르면 삭제됩니다',
  ...
  'settings.tabIntegrations': '연동',
  'settings.tabAbout': '정보',
  'settings.aboutFeedback': '피드백',
  'settings.aboutGithub': 'GitHub 저장소',
  'settings.aboutIssues': '버그·기능 요청',
  ...
  'settings.confluenceTurnOnAllConfirm': '한 번 더 누르면 모든 팀 스페이스를 미러링합니다',
  ...
  'settings.scopeHint': '↑↓ 이동 · ↵ 추가 · Esc 닫기',
  ...
  'settings.integrationsIntro':
    '에이전트가 이 미러에 닿는 경로입니다. 설치 버튼은 아래에 적힌 명령을 그대로 실행합니다 — 직접 실행하려면 복사하세요.',
  'settings.integrationsLoading': '설치 상태를 읽는 중…',
  'settings.integrationsLoadFailed': '앱에서 연동 목록을 읽지 못했습니다.',
  'settings.integrationsEmpty': '이 빌드에는 연동 항목이 없습니다.',
  'settings.integrationInstalled': '설치됨',
  'settings.integrationNotInstalled': '설치되지 않음',
  'settings.integrationUnknown': '상태 불명',
  'settings.integrationUnknownHint':
    '이 항목의 감지는 확정이 아니라 이미 설치돼 있을 수도 있습니다. 다시 확인하거나, 그냥 명령을 실행하세요 — 다시 설치해도 안전합니다.',
  'settings.integrationResultUnknown': '결과 불명',
  'settings.integrationChecking': '확인 중…',
  'settings.integrationRunning': '설치 중…',
  'settings.integrationFailed': '설치 실패',
  'settings.integrationInstall': '설치',
  'settings.integrationUpdate': '업데이트',
  'settings.integrationRetry': '다시 시도',
  'settings.integrationRecheck': '다시 확인',
  'settings.integrationCopyCommand': '명령 복사',
  'settings.integrationOutput': '명령 출력',
  'settings.integrationExitCode': '명령이 종료 코드 {code}으로 끝났습니다.',
  'settings.integrationBusy': '이미 설치가 실행 중입니다. 그 출력은 여기에 표시되지 않습니다.',
  'settings.integrationUnknownId': '이 앱이 모르는 연동입니다.',
  'settings.integrationStartFailed': '설치를 시작하지 못했습니다.',
  'settings.integrationNoExit':
    '명령이 상태를 알리기 전에 출력이 끊겼습니다. 성공했는지 알 수 없으니 다시 확인해 주세요.',
  'settings.integrationOkUndetected':
    '명령은 성공했다고 보고했지만 아직 감지되지 않습니다. 대상 앱을 재시작한 뒤 다시 확인해 보세요. 위 출력이 실제로 실행된 내용입니다.',
  'settings.integrationPrereq': '설치하기 전에 먼저 준비해야 할 것이 있습니다.',
  ...
  'palette.actionDocs': '문서 열기',
  'palette.actionFeed': '피드 열기',
  'palette.actionFavorite': '즐겨찾기 · {key}',
  'palette.actionUnfavorite': '즐겨찾기 해제 · {key}',
  'palette.actionWatch': '워치 · {key}',
  'palette.actionUnwatch': '워치 해제 · {key}',
  ...
  'shortcuts.sectionList': '이슈 목록',
  'shortcuts.sectionColumnViews': '문서·히스토리·피드',
  ...
  'shortcuts.newIssueContext': '새 이슈 (상세·커서가 없을 때)',
  ...
  'shortcuts.tabMoveRows': '문서·히스토리·피드 행 이동',
  'shortcuts.closeColumnView': '문서·히스토리·피드 닫기',
  'shortcuts.detailOpenJira': '이슈를 Jira에서 열기',
  ...
  'browse.backEsc': 'gadak로 돌아가기 (Esc)',
