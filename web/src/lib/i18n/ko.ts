...
export const ko = {
  ...
  'onboarding.introBefore': '아직 미러된 데이터가 없습니다. 터미널에서',
  'onboarding.introAfter': '를 실행하거나, 아래 3단계를 마치세요.',
  'onboarding.stepCredential': 'Jira 자격증명',
  'onboarding.stepCredentialHint': 'Jira 이메일과 API 토큰. 로컬에만 저장됩니다.',
  'onboarding.stepProjects': '프로젝트',
  'onboarding.stepProjectsHint': '미러가 다룰 프로젝트 키를 지정합니다.',
  'onboarding.stepSync': '첫 동기화',
  'onboarding.stepSyncHint': '위 두 단계가 끝나면 자동으로 시작됩니다.',
  'onboarding.chooseProjects': '프로젝트 선택',
  'onboarding.openSettings': '설정 열기',
  'onboarding.done': '완료',
  'onboarding.todo': '해야 함',
