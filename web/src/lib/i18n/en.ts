...
export const en = {
  ...
  'filter.chipResolvedRange': 'Resolved {from}–{to}',
  ...
  'view.resolvedWeek.hint': 'Resolved since Monday',
  ...
  'write.editDescription': 'Edit description',
  'write.descriptionFailed': 'Could not update description.',
  'write.descriptionFormatWarn': 'Saving will remove formatting and embeds.',
  'write.saveAsPlain': 'Save as plain text',
  ...
  'jiraSettings.deleteConfirm': 'Click again to delete',
  ...
  'settings.integrationsIntro':
    'Where your agents reach this mirror. Each install runs the command shown — copy it to run it yourself instead.',
  'settings.integrationsLoading': 'Reading what is installed…',
  'settings.integrationsLoadFailed': 'Could not read the integration list from the app.',
  'settings.integrationsEmpty': 'This build offers no integrations.',
  'settings.integrationInstalled': 'Installed',
  'settings.integrationNotInstalled': 'Not installed',
  'settings.integrationUnknown': 'Status unknown',
  'settings.integrationUnknownHint':
    'Detection here is best-effort, so this may already be in place. Re-check, or just run the command — installing again is safe.',
  'settings.integrationResultUnknown': 'Result unknown',
  'settings.integrationChecking': 'Checking…',
  'settings.integrationRunning': 'Installing…',
  'settings.integrationFailed': 'Setup failed',
  'settings.integrationInstall': 'Install',
  'settings.integrationUpdate': 'Update',
  'settings.integrationRetry': 'Retry',
  'settings.integrationRecheck': 'Re-check',
  'settings.integrationCopyCommand': 'Copy command',
  'settings.integrationOutput': 'Command output',
  'settings.integrationExitCode': 'The command exited with code {code}.',
  'settings.integrationBusy': 'An install is already running. Its output is not shown here.',
  'settings.integrationUnknownId': 'This app does not know that integration.',
  'settings.integrationStartFailed': 'Could not start the install.',
  'settings.integrationNoExit':
    'The output stopped before the command reported a status, so whether it worked is unknown. Re-check to ask again.',
  'settings.integrationOkUndetected':
    'The command reported success, but this still is not detected. It may need the target app restarted — Re-check after that. The output above is what ran.',
  'settings.integrationPrereq': 'Something has to be set up before this can be installed.',
  ...
  'palette.actionDocs': 'Open documents',
  'palette.actionFeed': 'Open feed',
  'palette.actionFavorite': 'Favorite · {key}',
  'palette.actionUnfavorite': 'Unfavorite · {key}',
  'palette.actionWatch': 'Watch · {key}',
  'palette.actionUnwatch': 'Unwatch · {key}',
  ...
  'onboarding.agentNoCli': 'No gadak in your terminal? In the desktop app: Settings → Integrations.',
  ...
  'shortcuts.sectionColumnViews': 'Documents, history, feed',
  ...
  'shortcuts.tabMoveRows': 'Move through rows in documents, history, and feed',
  'shortcuts.closeColumnView': 'Close documents, history, or feed',
