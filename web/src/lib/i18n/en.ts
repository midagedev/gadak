...
export const en = {
  ...
  'onboarding.introBefore': 'Nothing is mirrored yet. Run',
  'onboarding.introAfter': 'in a terminal, or finish the three steps below.',
  'onboarding.stepCredential': 'Jira credential',
  'onboarding.stepCredentialHint': 'Your Jira email and an API token, stored locally.',
  'onboarding.stepProjects': 'Projects',
  'onboarding.stepProjectsHint': 'Which project keys the mirror should cover.',
  'onboarding.stepSync': 'First sync',
  'onboarding.stepSyncHint': 'Runs automatically once the two steps above are done.',
  'onboarding.chooseProjects': 'Choose projects',
