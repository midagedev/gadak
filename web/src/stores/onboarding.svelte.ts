 ...
 * A built-in workspace has no Jira site to connect — the wizard would ask
 ...
 *  closes the wizard through me.identified flipping; the built-in door
...
import { config, isBuiltInWorkspace } from '../lib/config'
