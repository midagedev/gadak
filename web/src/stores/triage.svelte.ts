 ...
 * keys act on it from the shell's global handler (x/s/a/c): a component-local
 ...
 *      both go through this so `s` can open it without a click.
...
export type TriageMenu = 'status' | 'assignee'
