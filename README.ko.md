...
<p align="center">
  <img src="docs/media/phone.ko.gif" alt="폰에서 쓰는 장면 — Fields 구역과 첨부가 보이는 이슈, 상태를 진행 중으로 옮기고, 코멘트를 쓰고, 사진을 붙여 스레드에 올린다" width="260">
</p>

<p align="center"><sub>한 테이크 중 쓰는 절반입니다. <a href="https://gadak.dev/ko/#phone">전체는 사이트에서 재생됩니다</a> — GitHub 마크다운은 <code>&lt;video&gt;</code>를 지웁니다. 연출이 아니라 실제로 써집니다: 데모 스냅샷을 그 자체로 하나의 트래커로 띄워 놓고 찍었습니다.</sub></p>
...
**상태: 0.24, 아직 0.x입니다.** 동기화, 읽기 API, 쓰기, 데스크톱·웹·CLI·MCP를
