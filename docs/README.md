...
- [PROMISES.md](PROMISES.md): the claims worth checking, each with one command you can run in a clone to check it
...
- [runbooks/tailnet-serve.md](runbooks/tailnet-serve.md): a resident `gadak serve` on a tailnet host, from the tarball to a paired device
